...
const faqs = [
  {
    ...
    a: "Otuuse provides Boda-Boda rides, bicycle rides, car rides, package deliveries, and hostel moving services within Kabale."
  },
  {
  ...
  },
  {
    ...
    a: "You can easily book through the Request a Service page on our website, call our direct line, or send us a message on WhatsApp."
  },
  {
    q: "How much does Otuuse charge?",
    a: "Our pricing is transparent, fair, and designed with students in mind. Contact us via WhatsApp for a quick quote!"
  },
  {
    q: "Where exactly does Otuuse operate?",
    a: "We currently operate throughout Kabale town, including Kabale University, Kikungulu, and surrounding neighborhoods."
  },
  {
    q: "Is my package safe during delivery?",
    a: "Yes. Our riders are verified and trained to handle items with care. We ensure it reaches its destination safely."
  }
  {
